...
typedef struct
{
    FunctionalState ADC_DMAEnable;          /*!< 1 -- enable DMA; 0 -- disable DMA (default) */
...
typedef enum {
    INTL_ADC_CHAN_0 = (0x01),//internal adc channel 0
    INTL_ADC_CHAN_1 = (0x02),//internal adc channel 1
    EXTL_ADC_CHAN_0 = (0x04),//external adc channel 0
    EXTL_ADC_CHAN_1 = (0x08),//external adc channel 1
    EXTL_ADC_CHAN_2 = (0x10),//external adc channel 2
    EXTL_ADC_CHAN_3 = (0x20),//external adc channel 3
    EXTL_ADC_CHAN_4 = (0x40),//external adc channel 4
    EXTL_ADC_CHAN_5 = (0x80),//external adc channel 5
    ADC_CHAN_MAX = 8
} adc_chan_t;

#define IS_ADC_CHANMAP(chmap)   ( (chmap) & 0xFF )
#define IS_ADC_CHANX(chx)       (((chx) == INTL_ADC_CHAN_0) || \
                                ((chx) == INTL_ADC_CHAN_1) || \
                                ((chx) == EXTL_ADC_CHAN_0) || \
                                ((chx) == EXTL_ADC_CHAN_1) || \
                                ((chx) == EXTL_ADC_CHAN_2) || \
...
#define IS_ADC_PRESC(presc)         ((presc) <= 0xFF)
...
uint32_t *HAL_ADC_DataAddr_Get(ADC_Instance *ADCx, uint8_t chanx);
