...
typedef union
{
    ...
    struct
    {
        uint32_t              portadataregister : 21; /*20: 0, Values written to this register are output on the I/O signals for
...
typedef union
{
    ...
    struct
    {
        uint32_t     portadatadirectionregister : 21; /*20: 0, Values written to this register independently control the
...
typedef union
{
    ...
    struct
    {
        uint32_t              portbdataregister : 14; /*13: 0, Values written to this register are output on the I/O signals for
...
typedef union
{
    ...
    struct
    {
        uint32_t     portbdatadirectionregister : 14; /*13: 0, Values written to this register independently control the
...
typedef union
{
    ...
    struct
    {
        uint32_t                      int_level : 21; /*20: 0, Controls the type of interrupt that can occur on Port A. Whenever a 0 is written to a bit of this register, it configures the interrupt type to be level-sensitive; otherwise, it is edge-sensitive.
...
typedef union
{
    ...
    struct
    {
        uint32_t                   int_polarity : 21; /*20: 0, Controls the polarity of edge or level sensitivity that can occur on input of Port A. Whenever a 0 is written to a bit of this register, it configures the interrupt type to falling-edge or active-low sensitive; otherwise, it is rising-edge or active-high sensitive.
...
typedef union
{
    ...
    struct
    {
        uint32_t                     int_status : 21; /*20: 0,     Interrupt status of Port A*/
        uint32_t                     reserved_0 : 11; /*31:21,                       reserved*/
    } bit_field;
...
typedef union
{
    ...
    struct
    {
        uint32_t                 raw_int_status : 21; /*20: 0, Raw interrupt of status of Port A (premasking bits)*/
        uint32_t                     reserved_0 : 11; /*31:21,                       reserved*/
    } bit_field;
...
typedef union
{
    ...
    struct
    {
        uint32_t                      int_clear : 21; /*20: 0, Controls the clearing of edge type interrupts from Port A. When a 1 is written into a corresponding bit of this register, the interrupt is cleared. All interrupts are cleared when Port A is not configured for interrupts.
...
typedef union
{
    ...
    struct
    {
        uint32_t                      ext_porta : 21; /*20: 0, This register always reflects the signals value on the External Port A.*/
        uint32_t                     reserved_0 : 11; /*31:21,                       reserved*/
    } bit_field;
...
typedef union
{
    ...
    struct
    {
        uint32_t                      ext_portb : 14; /*13: 0, This register always reflects the signals value on the External Port B.*/
        uint32_t                     reserved_0 : 18; /*31:14,                       reserved*/
    } bit_field;
...
typedef union
{
    ...
    struct
    {
        uint32_t                  int_both_edge : 21; /*20: 0, Controls the edge type of interrupt that can occur on Port A.
...
__STATIC_INLINE void gpio_gpio_swporta_dr_pack(uint32_t portadataregister)
{
    hwp_gpio->gpio_swporta_dr.val = (((uint32_t)portadataregister << 0));
}

__STATIC_INLINE void gpio_gpio_swporta_dr_unpack(uint32_t* portadataregister)
{
...
__STATIC_INLINE uint32_t gpio_portadataregister_getf(void)
{
    return hwp_gpio->gpio_swporta_dr.bit_field.portadataregister;
}

__STATIC_INLINE void gpio_portadataregister_setf(uint32_t portadataregister)
{
...
__STATIC_INLINE void gpio_gpio_swporta_ddr_pack(uint32_t portadatadirectionregister)
{
    hwp_gpio->gpio_swporta_ddr.val = (((uint32_t)portadatadirectionregister << 0));
}

__STATIC_INLINE void gpio_gpio_swporta_ddr_unpack(uint32_t* portadatadirectionregister)
{
...
__STATIC_INLINE uint32_t gpio_portadatadirectionregister_getf(void)
{
    return hwp_gpio->gpio_swporta_ddr.bit_field.portadatadirectionregister;
}

__STATIC_INLINE void gpio_portadatadirectionregister_setf(uint32_t portadatadirectionregister)
{
...
__STATIC_INLINE void gpio_gpio_inten_pack(uint32_t interruptenable)
{
    hwp_gpio->gpio_inten.val = (((uint32_t)interruptenable << 0));
}

__STATIC_INLINE void gpio_gpio_inten_unpack(uint32_t* interruptenable)
{
...
__STATIC_INLINE uint32_t gpio_interruptenable_getf(void)
{
    return hwp_gpio->gpio_inten.bit_field.interruptenable;
}

__STATIC_INLINE void gpio_interruptenable_setf(uint32_t interruptenable)
{
...
__STATIC_INLINE void gpio_gpio_intmask_pack(uint32_t int_mask)
{
    hwp_gpio->gpio_intmask.val = (((uint32_t)int_mask << 0));
}

__STATIC_INLINE void gpio_gpio_intmask_unpack(uint32_t* int_mask)
{
...
__STATIC_INLINE uint32_t gpio_int_mask_getf(void)
{
    return hwp_gpio->gpio_intmask.bit_field.int_mask;
}

__STATIC_INLINE void gpio_int_mask_setf(uint32_t int_mask)
{
...
__STATIC_INLINE void gpio_gpio_inttype_level_pack(uint32_t int_level)
{
    hwp_gpio->gpio_inttype_level.val = (((uint32_t)int_level << 0));
}

__STATIC_INLINE void gpio_gpio_inttype_level_unpack(uint32_t* int_level)
{
...
__STATIC_INLINE uint32_t gpio_int_level_getf(void)
{
    return hwp_gpio->gpio_inttype_level.bit_field.int_level;
}

__STATIC_INLINE void gpio_int_level_setf(uint32_t int_level)
{
...
__STATIC_INLINE void gpio_gpio_int_polarity_pack(uint32_t int_polarity)
{
    hwp_gpio->gpio_int_polarity.val = (((uint32_t)int_polarity << 0));
}

__STATIC_INLINE void gpio_gpio_int_polarity_unpack(uint32_t* int_polarity)
{
...
__STATIC_INLINE uint32_t gpio_int_polarity_getf(void)
{
    return hwp_gpio->gpio_int_polarity.bit_field.int_polarity;
}

__STATIC_INLINE void gpio_int_polarity_setf(uint32_t int_polarity)
{
...
__STATIC_INLINE void gpio_gpio_intstatus_unpack(uint32_t* int_status)
{
...
__STATIC_INLINE uint32_t gpio_int_status_getf(void)
{
...
__STATIC_INLINE void gpio_gpio_raw_intstatus_unpack(uint32_t* raw_int_status)
{
...
__STATIC_INLINE uint32_t gpio_raw_int_status_getf(void)
{
...
__STATIC_INLINE void gpio_gpio_debounce_pack(uint32_t debounceenable)
{
    hwp_gpio->gpio_debounce.val = (((uint32_t)debounceenable << 0));
}

__STATIC_INLINE void gpio_gpio_debounce_unpack(uint32_t* debounceenable)
{
...
__STATIC_INLINE uint32_t gpio_debounceenable_getf(void)
{
    return hwp_gpio->gpio_debounce.bit_field.debounceenable;
}

__STATIC_INLINE void gpio_debounceenable_setf(uint32_t debounceenable)
{
...
__STATIC_INLINE void gpio_gpio_porta_eoi_pack(uint32_t int_clear)
{
...
__STATIC_INLINE void gpio_gpio_ext_porta_unpack(uint32_t* ext_porta)
{
...
__STATIC_INLINE uint32_t gpio_ext_porta_getf(void)
{
...
__STATIC_INLINE void gpio_gpio_int_bothedge_pack(uint32_t int_both_edge)
{
    hwp_gpio->gpio_int_bothedge.val = (((uint32_t)int_both_edge << 0));
}

__STATIC_INLINE void gpio_gpio_int_bothedge_unpack(uint32_t* int_both_edge)
{
...
__STATIC_INLINE uint32_t gpio_int_both_edge_getf(void)
{
    return hwp_gpio->gpio_int_bothedge.bit_field.int_both_edge;
}

__STATIC_INLINE void gpio_int_both_edge_setf(uint32_t int_both_edge)
{
