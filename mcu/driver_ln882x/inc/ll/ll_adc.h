 ...
 */
void LL_ADC_DMAEN_Set(ADC_Instance *ADCx, uint8_t en);

uint8_t LL_ADC_DMAEN_Get(ADC_Instance *ADCx);
...
///////////////////////////////////////////////////////////////////////////////
uint16_t LL_ADC_Data0_Get_compensate(ADC_Instance *ADCx);

uint32_t *LL_ADC_DataAddr_Get(ADC_Instance *ADCx, uint8_t chanX);
