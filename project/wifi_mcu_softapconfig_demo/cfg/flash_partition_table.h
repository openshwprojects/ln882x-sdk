...
#define NVDS_SPACE_OFFSET                (0x0000A000)
#define NVDS_SPACE_SIZE                  (1024*12)
#if (NVDS_SPACE_OFFSET < (PART_TAB_SPACE_OFFSET + PART_TAB_SPACE_SIZE))
  #error "flash partition overlap,please check <flash_partition_table.json>!!!"
#endif

#define APP_SPACE_OFFSET                 (0x0000D000)
#define APP_SPACE_SIZE                   (1024*1000)
#if (APP_SPACE_OFFSET < (NVDS_SPACE_OFFSET + NVDS_SPACE_SIZE))
  #error "flash partition overlap,please check <flash_partition_table.json>!!!"
#endif

#define OTA_SPACE_OFFSET                 (0x00107000)
#define OTA_SPACE_SIZE                   (1024*800)
#if (OTA_SPACE_OFFSET < (APP_SPACE_OFFSET + APP_SPACE_SIZE))
  #error "flash partition overlap,please check <flash_partition_table.json>!!!"
#endif

#define KV_SPACE_OFFSET                  (0x001CF000)
#define KV_SPACE_SIZE                    (1024*16)
#if (KV_SPACE_OFFSET < (OTA_SPACE_OFFSET + OTA_SPACE_SIZE))
  #error "flash partition overlap,please check <flash_partition_table.json>!!!"
#endif

#define USER_SPACE_OFFSET                (0x001D3000)
#define USER_SPACE_SIZE                  (1024*180)
