...
#define console_printf(...)     __wrap_sprintf((stdio_write_fn)command_stdio_write, __VA_ARGS__)
#else
#define console_printf(...)     __wrap_sprintf((stdio_write_fn)NULL, __VA_ARGS__)
#endif
